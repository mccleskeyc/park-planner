...
export class SunsetBlvd extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Sunset Boulevard" && plan.props.park === "Hollywood Studios")
        return (
            <div>
                <h1><u>All Sunset Boulevard Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(SunsetBlvd)