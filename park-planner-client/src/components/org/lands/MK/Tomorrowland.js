...
export class Tomorrowland extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Tomorrowland" && plan.props.park === "Magic Kingdom")
        return (
            <div>
                <h1><u>All Tomorrowland Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(Tomorrowland)