...
class Frontierland extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Frontierland" && plan.props.park === "Magic Kingdom")
        return (
            <div>
                <h1><u>All Frontierland Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(Frontierland)
