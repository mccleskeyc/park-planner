...
class LibertySquare extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Liberty Square" && plan.props.park === "Magic Kingdom")
        return (
            <div>
                <h1><u>All Liberty Square Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(LibertySquare)