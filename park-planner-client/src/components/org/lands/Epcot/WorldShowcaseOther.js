...
export class WorldShowcaseOther extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "World Showcase - Other" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All World Showcase - Other Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(WorldShowcaseOther)
