...
export class France extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "France" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All France Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(France)