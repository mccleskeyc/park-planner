...
export class AmericanAdventure extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "American Adventure" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All American Adventure Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(AmericanAdventure)
