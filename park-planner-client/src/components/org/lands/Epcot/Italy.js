...
export class Italy extends Component {
    rrender() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Italy" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All Italy Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(Italy)