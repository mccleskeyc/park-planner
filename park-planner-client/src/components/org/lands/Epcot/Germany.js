...
export class Germany extends Component {
    render() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Germany" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All Germany Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(Germany)