...
export class Japan extends Component {
    rrender() {
        ...
        const filteredPlans = plans.filter(plan => plan.props.land === "Japan" && plan.props.park === "Epcot")
        return (
            <div>
                <h1><u>All Japan Plans</u></h1>
                <div>
                    {filteredPlans}
                </div>
            </div>
...
export default connect(mapStateToProps)(Japan)